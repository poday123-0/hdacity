...
const vehicleIcon = (imageUrl?: string) => {
  if (imageUrl) {
    return L.divIcon({
      ...
      iconSize: [28, 28],
      iconAnchor: [14, 14],
      html: `<img src="${imageUrl}" style="width:28px;height:28px;object-fit:contain;" crossorigin="anonymous" />`,
    });
  }
  return L.divIcon({
    className: "",
...
const driverIcon = (iconUrl?: string | null) => {
  if (iconUrl) {
    return L.divIcon({
      ...
      iconSize: [36, 36],
      iconAnchor: [18, 18],
      html: `<img src="${iconUrl}" style="width:36px;height:36px;object-fit:contain;" crossorigin="anonymous" />`,
    });
  }
  return L.divIcon({
    className: "",
